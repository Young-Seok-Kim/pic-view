...
<img src="docs/screenshots/23-course-timeline.png" width="260" align="right" alt="빛 스케줄 타임라인" />
...
<p>
  <img src="docs/screenshots/04-explore.png" width="240" alt="탐색 - 빛이 맞는 출사" />
...
- 지도 마커는 **주제별 색 체계** 그대로 — 자연(초록) · 문화(단풍) ·
  레포츠(파랑) · 맛집(골든)
...
빛 스케줄 계산, 코스 배치 규칙, 미션 판정(장면 세기), 계절 D-day,
