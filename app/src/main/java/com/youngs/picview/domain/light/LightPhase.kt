...
enum class LightPhase(
    ...
    BLUE_DAWN("새벽 블루아워", "하늘이 푸르게 깔리는 20분", R.color.light_blue_dawn),
    ...
    /** 남중 후 ~ 일몰 전. */
    AFTERNOON("오후", "그림자가 길어지기 시작", R.color.light_afternoon),

    /** 일몰 전후. 서향 스팟의 최적 시간. */
    SUNSET("일몰 골든아워", "하루 중 가장 붉은 빛", R.color.light_sunset),

    /** 일몰 후 파란 빛. */
    BLUE_DUSK("저녁 블루아워", "가로등과 하늘이 함께 담기는 20분", R.color.light_blue_dusk),
